                ...
                <form method="post" action="{{ route('funcionario.store') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control required" id="inputMatricula" type="text"
                               placeholder="Matrícula do funcionário" name="matricula" maxlength="10" required/>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control" id="inputDataAdmissao" type="date"
                                       placeholder="DD/MM/AAAA" name="dataAdmissao" required value=""/>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control" id="inputDataDemissao" type="date"
                                       placeholder="DD/MM/AAAA" name="dataDemissao" value=""/>
