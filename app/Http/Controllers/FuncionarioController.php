...
class FuncionarioController extends Controller
{
    ...
    public function index()
    {
        $funcionarios = DB::select('
            SELECT
                funcionario.id, funcionario.matricula, pessoa.nome,
                pessoa.cpf, funcionario.dataDemissao
            FROM
                funcionario
    ...
    public function create()
    {
        ...
        return view('funcionario.create', ['pessoas' => $pessoas]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::insert('INSERT INTO funcionario (matricula, dataAdmissao, dataDemissao, pessoa_id, created_at, updated_at) VALUES (?, ?, ?, ?, NOW(), NOW())',
                [
            ...
            return redirect()->route('funcionario.index')->with('success', 'Cadastro realizado com sucesso!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function show(string $id)
    {
        ...
        $pessoa = DB::select('SELECT * FROM pessoa WHERE id = ?', [$funcionario[0]->pessoa_id]);
